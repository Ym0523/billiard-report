...
.autoord{width:100%;padding:14px 14px;margin:8px 0 4px;border:0;border-radius:12px;background:var(--accent);color:#fff;font-size:15px;font-weight:800;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;}
.autoord:disabled{opacity:.45;cursor:default;}
.autoord.alt{background:var(--surface);color:var(--accent);border:1.5px solid var(--accent);margin-top:8px;}
.autoord .sub{font-size:12px;font-weight:700;opacity:.85;}
.amzbox{border:1px solid var(--accent);border-radius:12px;padding:10px 12px;margin:2px 0 14px;background:var(--accent-sf);}
.amzhd{font-weight:800;font-size:14px;color:var(--ink);margin-bottom:2px;}
.amzrow{display:flex;align-items:center;gap:8px;padding:8px 0;border-bottom:1px solid var(--line);}
.amzrow:last-of-type{border-bottom:0;}
.amzright{display:flex;flex-direction:column;align-items:flex-end;gap:6px;}
.amzact{display:flex;align-items:center;gap:4px;flex-wrap:wrap;justify-content:flex-end;}
.b.sm{padding:8px 12px;font-size:13px;}
.lnk{background:transparent;border:0;color:var(--ink3);font-size:16px;cursor:pointer;padding:4px 6px;}
.amznote{font-size:11px;color:var(--ink2);margin-top:8px;line-height:1.5;}
.amzrow.skip{opacity:.5;}
.stg{color:var(--accent);font-weight:800;}
.skp{color:var(--ink3);font-weight:700;}
.linktoggle{display:block;width:100%;text-align:left;background:transparent;border:0;color:var(--accent);font-weight:800;font-size:13px;padding:12px 2px;cursor:pointer;}
.linkbox{border:1px solid var(--line);border-radius:12px;padding:2px 12px;margin-bottom:12px;}
.sbtn.z{width:34px;height:40px;font-size:14px;font-weight:800;color:var(--ink3);}
